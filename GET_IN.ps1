...
Write-Host "  User intake:     https://peeezmachine-appflow.netlify.app/?token=YOUR_SECRET"
Write-Host "  Command center:  https://automationforge-429d00fc.netlify.app"
Write-Host "  Deploy intake:   npm run deploy:intake"
Write-Host "  Deploy admin:    npm run deploy:admin"
Write-Host ""
